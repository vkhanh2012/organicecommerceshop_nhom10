...
export function openQuickView(productData) {
  ...
  const decBtn = modalContainer.querySelector('[data-action="decrement"]') || modalContainer.querySelector('[data-action="decrease-qty"]');
  const incBtn = modalContainer.querySelector('[data-action="increment"]') || modalContainer.querySelector('[data-action="increase-qty"]');
...
// 📌 TỰ ĐỘNG LẮNG NGHE BẤM CON MẮT TOÀN BỘ WEB
