...
export function renderCartPage(cart = getCart()) {
  return `
    <section class="container-custom py-10 md:py-14">
      ...
      <h1 class="mb-8 text-center text-[32px] font-semibold">
        My Shopping Cart
      </h1>
      ...
      >
        ...
        <div>
          ...
          <div
            class="mt-6 rounded-lg border border-neutral-100 p-5
                   sm:flex sm:items-center sm:gap-6 sm:p-6"
          >

            <h2
              class="mb-3 shrink-0 text-xl font-medium sm:mb-0"
            >
              Coupon Code
            </h2>
            ...
            >
              ...
              <input
                class="min-w-0 flex-1 rounded-l-full border border-r-0
                       border-neutral-100 px-5 py-3 text-sm outline-none
          ...
          <p
            class="mt-2 hidden text-sm text-primary"
            data-cart-message
          ></p>
