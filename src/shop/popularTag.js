const TAGS_DATA = [
  ...
  { id: "tag-organic", name: "Organic", active: false },
  { id: "tag-gluten-free", name: "Gluten Free", active: false },
  { id: "tag-high-protein", name: "High Protein", active: false },
]
...
export function renderPopularTags() {
  ...
  return /*html*/ `
   <div class="border-b border-neutral-100">
        <div class="flex items-center justify-between cursor-pointer py-5">
