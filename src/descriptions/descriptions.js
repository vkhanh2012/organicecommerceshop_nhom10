    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 pb-16">
      ...
      <div class="lg:col-span-6 flex flex-col sm:flex-row gap-4">
        <div class="flex sm:flex-col items-center gap-3 order-2 sm:order-1 shrink-0">
          ...
          <!-- Ảnh nhỏ 2 -->
          <div class="w-[80px] h-[90px] border border-white/20 hover:border-[#00B207] rounded-lg overflow-hidden p-1 bg-white cursor-pointer transition-all flex items-center justify-center">
            <img src="../assets/images/cabbage2.svg" alt="Chinese Cabbage Thumbnail 2" class="w-full h-full object-contain" />
          </div>
          
          <!-- Ảnh nhỏ 3 -->
          <div class="w-[80px] h-[90px] border border-white/20 hover:border-[#00B207] rounded-lg overflow-hidden p-1 bg-white cursor-pointer transition-all flex items-center justify-center">
            <img src="../assets/images/cabbage3.svg" alt="Chinese Cabbage Thumbnail 3" class="w-full h-full object-contain" />
          </div>
          
          <!-- Ảnh nhỏ 4 -->
          <div class="w-[80px] h-[90px] border border-white/20 hover:border-[#00B207] rounded-lg overflow-hidden p-1 bg-white cursor-pointer transition-all flex items-center justify-center">
            <img src="../assets/images/cabbage4.svg" alt="Chinese Cabbage Thumbnail 4" class="w-full h-full object-contain" />
          </div>
        ...
        <div class="w-full aspect-square bg-white border border-gray-100 rounded-2xl flex items-center justify-center p-6 order-1 sm:order-2">
          <img src="../assets/images/largecabage.svg" alt="Chinese Cabbage Main Image" class="w-full h-full object-contain max-h-[400px]" />
        </div>
      </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 pt-12">
      ...
      <div class="lg:col-span-5 space-y-6">
        <div class="relative w-full aspect-[16/10] rounded-2xl overflow-hidden shadow-xs border border-gray-100">
          <svg width="536" height="300" viewBox="0 0 536 300" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            <g clip-path="url(#clip0_460_43073)">
            <rect width="536" height="300" rx="6" fill="url(#pattern0_460_43073)"/>
            <circle cx="268" cy="150" r="25" fill="#00B307"/>
            <path d="M263 141V159L277 150L263 141Z" fill="white"/>
            </g>
            <defs>
            <pattern id="pattern0_460_43073" patternContentUnits="objectBoundingBox" width="1" height="1">
            <use xlink:href="#image0_460_43073" transform="matrix(0.00176434 0 0 0.00315229 -0.0522388 -0.0805857)"/>
            </pattern>
            <clipPath id="clip0_460_43073">
