...
export function renderTestimonialComponent() {
  return /*html*/ `
    <!-- Khung ngoài của testimonial -->
        <div class="w-full h-auto bg-neutral-100 py-8 sm:py-10 md:py-12 lg:py-16 flex flex-col gap-5 sm:gap-6 md:gap-8 lg:gap-9 mx-auto">
            <!-- Tiêu đề và nút -->
              <div class="flex flex-col sm:flex-row w-full max-w-[1320px] px-4 sm:px-6 lg:px-8 text-[24px] sm:text-[28px] md:text-[32px] font-semibold text-neutral-900 justify-between pb-6 sm:pb-7 md:pb-8 mx-auto">
                <h1 class="text-[24px] sm:text-[28px] md:text-[32px] font-semibold text-neutral-900">Client Testimonials</h1>
