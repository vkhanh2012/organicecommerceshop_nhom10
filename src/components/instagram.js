...
const CLASS = {
  ...
  title: "font-poppins font-semibold text-xl md:text-2xl text-neutral-900 text-center mb-6 md:mb-8",
  grid: "grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2 md:gap-4",
