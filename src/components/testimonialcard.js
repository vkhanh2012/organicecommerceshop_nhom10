export function renderTestimonialCardComponent() {
    ...
    <div class="testimonial-card">
        <div>
            <!--Dấu nháy kép-->
            <div class="testimonial-quote"> <svg width="32" height="26" viewBox="0 0 32 26" fill="none" xmlns="http://www.w3.org/2000/svg">
             ...
             <!--Phần bình luận-->
             <p class="testimonial-comment-text"> Pellentesque eu nibh eget mauris congue mattis mattis nec tellus. Phasellus imperdiet elit eu magna dictum, bibendum cursus velit sodales. Donec sed neque eget</p>
             <!--Phần thông tin người bình luận-->
            <div class="client-card">
                <img class="client-avatar" src="https://cdn2.tuoitre.vn/thumb_w/730/471584752817336320/2026/1/29/9eab9419a970272e7e61-1769692346581810375237.jpg" alt="Client Avatar">
                <div class="client-info">
                    <p class="client-name">Jennie</p>
