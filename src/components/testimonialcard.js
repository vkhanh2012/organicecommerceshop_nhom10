export function renderTestimonialCardComponent() {
    return /*html*/ `
    <div class="flex flex-col justify-between bg-white w-full h-[254px] p-6 shadow-md border border-gray-100 rounded-lg">
            <!--Dấu nháy kép-->
        <div>
            <div class="w-[32px] h-[26px] flex items-center justify-center">
             ...
             <!--Phần bình luận-->
             <p class="font-['Poppins'] text-gray-700 text-base mt-4 mb-6 text-left"> Pellentesque eu nibh eget mauris congue mattis mattis nec tellus. Phasellus imperdiet elit eu magna dictum, bibendum cursus velit sodales. Donec sed neque eget
             </p>
             <!--Phần thông tin người bình luận-->
            <div class="flex flex-row items-center gap-3">
                <img class=" w-[56px] h-[56px] rounded-full object-cover" src="https://cdn2.tuoitre.vn/thumb_w/730/471584752817336320/2026/1/29/9eab9419a970272e7e61-1769692346581810375237.jpg" alt="Client Avatar">
...
// export function renderTestimonialCardComponent() {
//     return `
//     <div class="flex flex-col justify-between bg-white w-[424px] h-[254px] p-6 shadow-md border border-gray-100 rounded-lg">
//         <div>
//             <!-- Dấu nháy kép -->
//             <div class="w-[32px] h-[26px] flex items-center justify-center">
//                 <svg width="32" height="26" viewBox="0 0 32 26" fill="none" xmlns="http://www.w3.org/2000/svg">
...
//             <!-- Phần bình luận -->
//             <p class="font-['Poppins'] text-gray-700 text-base mt-4 mb-6 text-left">
...
//                 <!-- Cụm chữ xếp dọc thẳng hàng từ lề trái -->
//                 <div class="flex flex-col items-start w-auto">
//                     <p class="font-bold text-gray-900 leading-tight">Jennie</p>
//                     <p class="text-gray-400 text-sm mt-0.5">Customer</p>
//                 </div>
//             </div>
//         </div>
//     </div>
