...
export function renderTestimonialComponent(){
    ...
    <!-- Khung ngoài của testimonial -->
        <div class="w-full max-w-[1920px] h-auto bg-gray-100 py-8 sm:py-10 md:py-12 lg:py-16 px-4 flex flex-col gap-5 sm:gap-6 md:gap-8 lg:gap-9 mx-auto">
            <!-- Tiêu đề và nút -->
            <div class="flex flex-col sm:flex-row w-full max-w-[1320px] text-[24px] sm:text-[28px] md:text-[32px] font-semibold text-gray-900 justify-between pb-6 sm:pb-7 md:pb-8 mx-auto">
            ...
            <!-- Testimonial cards -->
            <div class="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-3 w-full max-w-[1320px] gap-4 sm:gap-5 md:gap-6 mx-auto">
