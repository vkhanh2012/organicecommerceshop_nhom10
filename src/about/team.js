...
export function renderTeamSection(){
    ...
    .join("");
    return /*html*/`
        <section class="container-custom flex flex-col sm:flex-cols-2 items-center w-full bg-white"  aria-labelledby="about-team-title>
            <!-- Tiêu đề và mô tả -->
            <div class="flex flex-col max-w-160 text-center space-y-3">
                <h2 class="text-title-900 font-semibold text-2xl sm:text-[28px] md:text-4xl lg:text-[48px]">
