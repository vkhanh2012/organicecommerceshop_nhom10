...
export function renderAboutUsSection() {
  return /*html*/ `
    <section
  class="w-full mx-auto px-4 py-6 md:py-14 bg-white" aria-labelledby="about-trusted-title">
    <div class="container-custom">
      <div class="flex flex-col md:flex-row gap-8 md:gap-8 lg:gap-12 items-center">
        ...
        <h2 id="about-trusted-title" class="text-lg sm:text-2xl md:text-4xl lg:text-[56px] text-title font-semibold leading-tight">
